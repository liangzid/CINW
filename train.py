...
pre_train=torch.load(read_path)
new_input=model.state_dict().copy()

new_list=list(model.state_dict().keys())
train_list=list(pre_train.keys())
print('debug...**************************************************************')
#print('the dfnn size:{0}  the ResNet50 size: {1}'.format(len(new_list),len(train_list)))
#print('====='*10)
#print(new_list[0:267])
#print('================')
#print(train_list[-10:-1])


#delete the classifier parameters
for i in range(267):
    new_input[new_list[i]]=pre_train[train_list[i]]




model.load_state_dict(new_input,strict=False) #使得对应不上的参数被抛弃
#=============================================================================================
